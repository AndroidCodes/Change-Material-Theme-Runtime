package com.example.androidcodes.materialthemes.controller.home.material;
...
import com.example.androidcodes.materialthemes.R;
import com.example.androidcodes.materialthemes.controller.theme.MaterialTheme;
...
public class MaterialThemeDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public static MaterialThemeDialogFragment newInstance(Context context, @StringRes int titleResId,
        ...
        MaterialThemeDialogFragment fragment = newInstance(context.getString(titleResId),
                context.getString(messageResId), alertDialogTheme);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (mAlertDialogTheme != null) {
            ...
            alertDialogBuilder = new AlertDialog.Builder(parentActivity,
                    mAlertDialogTheme.getThemeResId());
        ...
        alertDialogBuilder.setTitle(mTitle).setMessage(mMessage).
                setPositiveButton(R.string.material_theme_dialog_button_positive, this).setNegativeButton(R.string.material_theme_dialog_button_negative, this);
