package com.example.androidcodes.materialthemes.controller.dialog;
...
public class DialogUtils {
    ...
    public static String showDialogFragment(FragmentManager fragmentManager,
            DialogFragment dialogFragment, String fragmentTag, boolean onlyIfNotDuplicate) {
