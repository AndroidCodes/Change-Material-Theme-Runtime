...
import com.example.androidcodes.materialthemes.controller.dialog.DialogUtils;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.fragment_material_theme_button_dialog_current_theme:
                ...
                MaterialThemeDialogFragment dialogFragment = MaterialThemeDialogFragment.
                        newInstance(v.getContext(), R.string.material_theme_current_theme,
                        R.string.material_theme_current_theme, null);
